...
const Search = () => {
    ...
    const { SearchedNewsData, setSearchedData, SearchedLoading, carouselData, fetchSearchedNews } = useContext(SearchedNewsContext);

    let isData = SearchedNewsData.length !== 0;
        ...
        <div className='poppins w-[60%] h-full px-3 py-3 md:px-8 md:py-6 overflow-y-scroll no-scrollbar will-change-scroll'>
            ...
            <div className='mt-4'>
                ...
                <div className="w-full relative">
                    {
                        SearchedLoading ? <div>Search for something you want to know</div> : isData ? <Carousel
                            opts={{
                                loop: true,
                            }}
                            className="w-full"
                        ...
                        </Carousel> : <div>Search for something else.</div>
                    }
                </div>
                {isData ? <div className='flex w-full mt-6 flex-col'>
                    {SearchedLoading ? <div></div> : <div className='flex items-center justify-between w-full poppins'>
