...
import { HealthNewsContext } from '../../Context/AllNewsContext'
...
const Health = () => {
    ...
    const { HealthNewsData, setHealthData, HealthLoading, carouselData, fetchHealthNews } = useContext(HealthNewsContext);
        ...
        <div className='poppins w-[60%] h-full px-3 py-3 md:px-8 md:py-6 overflow-y-scroll no-scrollbar will-change-scroll'>
            ...
            <div className='mt-4'>
                ...
                <div className="w-full relative">
                    {
                        HealthLoading ? <div>Loading...</div> : <Carousel
                            opts={{
                                loop: true,
                            }}
                            className="w-full"
