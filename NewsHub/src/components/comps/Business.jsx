...
import { BusinessNewsContext } from '../../Context/AllNewsContext'
...
const Business = () => {
    ...
    const { BusinessNewsData, setBusinessData, BusinessLoading, carouselData, fetchBusinessNews } = useContext(BusinessNewsContext);
        ...
        <div className='poppins w-[60%] h-full px-3 py-3 md:px-8 md:py-6 overflow-y-scroll no-scrollbar will-change-scroll'>
            ...
            <div className='mt-4'>
                ...
                <div className="w-full relative">
                    {
                        BusinessLoading ? <div>Loading...</div> : <Carousel
                            opts={{
                                loop: true,
                            }}
                            className="w-full"
