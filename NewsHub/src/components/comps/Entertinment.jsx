...
import { EntertainmentNewsContext } from '../../Context/AllNewsContext'
...
const Entertainment = () => {
    ...
    const { EntertainmentNewsData, setEntertainmentData, EntertainmentLoading, carouselData, fetchEntertainmentNews } = useContext(EntertainmentNewsContext);
    ...
    const handleViewNews = (id) => {
        ...
        EntertainmentNewsData.forEach((item) => {
            if (item.id == id) {
                viewNews = item;
            }
        })
        ...
        <div className='poppins w-[60%] h-full px-3 py-3 md:px-8 md:py-6 overflow-y-scroll no-scrollbar will-change-scroll'>
            ...
            <div className='mt-4'>
                ...
                <div className="w-full relative">
                    {
                        EntertainmentLoading ? <div>Loading...</div> : <Carousel
                            opts={{
                                loop: true,
                            }}
                            className="w-full"
                ...
                <div className='flex w-full mt-6 flex-col'>
                    ...
                    {
                        EntertainmentNewsData.map((item) => (
                            <div
                                key={item.id}
